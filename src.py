...
ax1.set_title('Target Variable Distribution (Churn)', fontsize=10, fontweight='bold', pad=20)
...
ax2.set_title('Tenure Distribution by Churn', fontsize=10, fontweight='bold')
...
ax4.set_title('Tenure - Quartile Analysis', fontsize=10, fontweight='bold')
...
ax5.set_title('Monthly Charges - Quartile Analysis', fontsize=10, fontweight='bold')
...
ax6.set_title('Total Charges - Quartile Analysis', fontsize=10, fontweight='bold')
