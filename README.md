...
|-------------|-------------|
| 📁 [Src](https://github.com/HannanehCharmgar/GradientBoosting/tree/main/Src) | Main folder |
| - [`src.ipynb`](https://github.com/HannanehCharmgar/GradientBoosting/blob/main/Src/src.ipynb) | GB Catboost NB |
